export const BrewlabsLockupAddress =
  "0x9132AdAf85802A025d8F3830126E3E9894a451f9";

export const BrewlabsLockupABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "hasLimit", type: "bool" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_totalStakedLimit", type: "uint256" },
    ],
    name: "addLockup",
    outputs: [],
  ...
  {
    inputs: [{ internalType: "uint8", name: "_stakeType", type: "uint8" }],
    name: "claimDividend",
    outputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_dividendToken", type: "address" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "totalStakedLimit", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
