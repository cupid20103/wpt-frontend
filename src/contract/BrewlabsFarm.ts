export const BrewlabsFarmAddress = "0x2040726132171f2F9472b1Bd0E5CeAdb3BAE002C";

export const BrewlabsFarmABI = [
  {
    inputs: [
      { internalType: "contract IERC20", name: "_brews", type: "address" },
      { internalType: "address", name: "_reflectionToken", type: "address" },
      { internalType: "uint256", name: "_rewardPerBlock", type: "uint256" },
      { internalType: "bool", name: "_hasDividend", type: "bool" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint16", name: "_depositFee", type: "uint16" },
      { internalType: "uint16", name: "_withdrawFee", type: "uint16" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint16", name: "depositFee", type: "uint16" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address[]", name: "_earnedToToken0", type: "address[]" },
      { internalType: "address[]", name: "_earnedToToken1", type: "address[]" },
      {
        internalType: "address[]",
